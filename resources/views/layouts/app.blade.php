...
<head>
  ...
  <title>PERPUS INFORMATIKA</title>
  <!-- plugins:css -->
...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="index.html" style="color: black">
          PERPUS INFORMATIKA
        </a>
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            ...
            <a href="https://www.instagram.com/muhardika_j/ target="_blank">Jamaludin</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
